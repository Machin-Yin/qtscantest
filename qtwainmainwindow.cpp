	...
	: QMainWindow(parent, f)
{
    ...
    m_pTwain->initTwain((HWND)m_pWidget->winId());

    QStringList scanList = m_pTwain->getScanList();
    ...
    QVector<TW_IDENTITY> srcArray = m_pTwain->getScanSrc();
    qDebug()<<"srcArray.at(1).ProductName ========" <<srcArray.at(3).ProductName;
    m_pTwain->my_sleSrc(srcArray.at(3));
